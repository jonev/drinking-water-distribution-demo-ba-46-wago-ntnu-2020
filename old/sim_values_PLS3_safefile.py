...
class SimValuesPLS3:
    def __init__(self,):
        ...
        self.flowValueTableFormat = "(id INT AUTO_INCREMENT PRIMARY KEY, metric VARCHAR(3), datetimestamp DATETIME, datestamp DATE, timestamp TIME, time_from TIME, time_to TIME, _tagId VARCHAR(20), value FLOAT)"
        self.flowValueTableInsert = (
            "INSERT INTO "
            + self.flowValueTableName
            + " (metric, datetimestamp, datestamp, timestamp, time_from, time_to, _tagId, value) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)"
        )
        self.cursor.execute(
    ...
    def sendValuesToDb(self,):
        ...
        self.val = (
            ...
            self.timestamp_sample.date(),
            self.timestamp_sample.time(),
            self.timestamp_sample.time(),
            self.timestamp_sample.time(),
            "FT01",
