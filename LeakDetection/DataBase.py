...
class DataBase:
    ...
    def getValues_BetweenTimestamps(
        self, table_name, timestamp_from, timestamp_to, _tagId
    ):  # OK TESTET
        self.cursor.execute(
            "SELECT * FROM "
            + table_name
            + " WHERE datetimestamp >= %s AND datetimestamp <%s AND _tagId=%s",
    ...
    def pushValue_OnTimestamp(self, table_name, datetimestamp, _tagId, value):  # OK TESTET
